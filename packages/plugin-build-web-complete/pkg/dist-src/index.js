...
export async function loadAllBabelPlugins() {
    ...
    const ES2017 = [...ES2018, import('@babel/plugin-transform-async-to-generator')];
    const ES2016 = [...ES2017, import('@babel/plugin-transform-exponentiation-operator')];
    const ES2015 = [
        ...ES2016,
...
async function buildSingleDist(distTag, distPlugins, { out, reporter }) {
